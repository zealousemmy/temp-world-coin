              ...
              <div className="col-lg-8 col-xxl-7">
                <div className="heading__content mb-10 mb-lg-15 text-center">
                  ...
                  <p className="fs-six-up mx-ch mx-auto">
                    ...
                    for our users and to get your feedback - please tell us what
                ...
                <div className="roadmap__content">
                  ...
                  <div className="roadmap__part">
                    <div className="event cus-rounded-1 p-4 p-md-5 p-xxl-10 me-5">
                      ...
                      <p className="mt-4">
                        The Forex market is incredibly liquid ensuring that you
                        can enter and exit positions easily even with large
                        amounts of capital.
                      </p>
                    </div>
                  </div>
                  <div className="roadmap__part">
                    <div className="event cus-rounded-1 p-4 p-md-5 p-xxl-10">
                      ...
                      <p className="mt-4">
                        The world of finance offers a multitude of opportunities
                        for individuals seeking to build their wealth and
                        explore new horizons. Forex trading,{" "}
                      </p>
                    </div>
                  </div>
                  <div className="roadmap__part">
                    <div className="event cus-rounded-1 p-4 p-md-5 p-xxl-10 me-5">
                      ...
                      <p className="mt-4">
                        ...
                        fundamentals of Forex trading, helping you how it works,
                  ...
                  <div className="roadmap__part">
                    <div className="event cus-rounded-1 p-4 p-md-5 p-xxl-10">
                      ...
                      <p className="mt-4">
                        Currencies on the foreign exchange market with the aim
                        of making a profit. It's the largest and most liquid
                  ...
                  <div className="roadmap__part">
                    <div className="event cus-rounded-1 p-4 p-md-5 p-xxl-10 me-5">
                      ...
                      <p className="mt-4">
                        {" "}
                        With a daily trading volume that exceeds $6 trillion.
                  ...
                  <div className="roadmap__part">
                    <div className="event cus-rounded-1 p-4 p-md-5 p-xxl-10">
                      ...
                      <p className="mt-4">
                        Unlike traditional stock markets, where you buy and sell
                        shares of companies, Forex trading involves the exchange
...
export default RoadMapPageContents;
